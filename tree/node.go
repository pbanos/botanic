...
type Node struct {
	...
	// For growing trees it is the criterion that applied to the parent node's dataset produces
	// this node's dataset.
	...
	// For growing trees it is the feature that splits the data into datasets for the nodes
