...
/*
UndefinedFeature represents a property about whose value we do not know
anything. It is used for unmarshalling of undefined feature criteria on trees.
*/
type UndefinedFeature ContinuousFeature
...
Name returns a string with the name of the feature
*/
func (uf *UndefinedFeature) Name() string {
	return uf.name
}

/*
Valid receives an interface value and returns a boolean and an error. It always
returns true and nil.
*/
func (uf *UndefinedFeature) Valid(value interface{}) (bool, error) {
	return true, nil
}

func (uf *UndefinedFeature) String() string {
	return uf.name
}
